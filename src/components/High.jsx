          ...
          <div className="col-lg-6 about-left-col pe-lg-5">
            <div className="about-text-content">
              ...
              <button 
                ...
                onClick={() => openPopup('AboutUs-DiscoverMore')}
              >
                Discover More 
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-right ms-2" viewBox="0 0 16 16">
