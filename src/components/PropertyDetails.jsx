...
const heroSlides = [
  {
    ...
    image: "https://ora-uae.com/sites/default/files/styles/max_2944x2944/public/2026-02/Sunray-Villa-Hero.jpg?itok=BQeOjhJ7"
  },
  {
    ...
    image: "https://i.pinimg.com/736x/55/5e/07/555e07a21bc683e4f162b74542832b42.jpg"
  },
  {
    title: "Elegant Interiors & Comfort",
    subtitle: "Crafted with precision to deliver an unparalleled lifestyle experience.",
    buttonText: "VIEW GALLERY",
    image: "https://i.pinimg.com/1200x/4f/24/76/4f24767dd3390b12d3b75f870a280aa2.jpg"
  }
];
   ...
   <div className="new-contact-container py-5 min-vh-100 d-flex align-items-center">
      <div className="container ">
        ...
        <div className="text-center mb-5 animate__animated animate__fadeInDown">
          ...
          <h1 className="display-4 fw-bold text-white mt-2 mb-3">Let's Build Something Exceptional</h1>
